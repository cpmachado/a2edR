...
\begin{enumerate}[label=\arabic{chapter}.\arabic*]
	...
	\item\addcontentsline{toc}{section}{4.4}\hfill
		\lstinputlisting[caption={ex4\_4.R}]{codigo/ieedr/ex4_4.R}
		\begin{enumerate}[label=\alph*)]
		\item\hfill
			\begin{figure}[h!]
				\centering
...
\part{Elementos de Estatística Descritiva}

\setcounter{chapter}{5}
\chapter{Exercícios Propostos}

\begin{enumerate}
	\item\addcontentsline{toc}{section}{Exercício 1}\hfill
		\begin{enumerate}[label=\alph*)]
			\item
			\item
		\end{enumerate}
	\item\addcontentsline{toc}{section}{Exercício 2}\hfill
		\begin{enumerate}[label=\alph*)]
			\item
			\item
		\end{enumerate}
	\item\addcontentsline{toc}{section}{Exercício 3}
	\item\addcontentsline{toc}{section}{Exercício 4}
	\item\addcontentsline{toc}{section}{Exercício 5}\hfill
		\begin{enumerate}[label=\alph*)]
			\item
			\item
			\item
		\end{enumerate}
	\item\addcontentsline{toc}{section}{Exercício 6}
	\item\addcontentsline{toc}{section}{Exercício 7}\hfill
		\begin{enumerate}[label=\alph*)]
			\item
			\item
			\item
		\end{enumerate}
	\item\addcontentsline{toc}{section}{Exercício 8}\hfill
		\begin{enumerate}[label=\alph*)]
			\item
			\item
			\item
